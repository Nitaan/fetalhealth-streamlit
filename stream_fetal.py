...
with col1:
    baseline_value = st.slider('Input Garis dasar detak jantung janin (denyut per menit)', 110.0, 160.0, value=120.0, )
with col1:
...
with col2:
    abnormal_short_term_variability	= st.number_input('Input Persentase waktu dengan variabilitas jangka pendek yang abnormal', min_value=0.0,
    max_value=100.0, value=73.0, step=0.001,  format="%.3f")
with col2:
...
with col2:
    ...
    max_value=100.0, value=43.0, step=0.001,  format="%.3f")
with col2:
